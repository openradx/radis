# Generated by Django 5.0.7 on 2024-08-10 17:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='reports.language')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='jobs', to='subscriptions.subscription')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('started_at', models.DateTimeField(blank=True, null=True)),
                ('ended_at', models.DateTimeField(blank=True, null=True)),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='subscriptions.subscriptionjob')),
                ('queued_job', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='procrastinate.procrastinatejob')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['owner', 'status'], name='subscriptio_owner_i_6261ab_idx'),
        ),
    ]
